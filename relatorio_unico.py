...
def gerar_pdf():
    ...
    col_widths = [14 * mm, 20 * mm, page_size[0] - 20 * mm - _fix, 12 * mm, 9 * mm, 14 * mm, 17 * mm]
    ...
    for idx_v, v in enumerate(ordem_vendedores):
        ...
        for row in rows_v:
            _, c, b, d, p, u, q, t = row
            table_data.append([c, b, Paragraph(esc_xml(d), ParagraphStyle("c", parent=styles["Normal"], fontSize=6.5, leading=6.8, spaceBefore=0, spaceAfter=0)), p, u, q, t])
        ...
        table_data.append(["", "", Paragraph("<b>Subtotal do vendedor</b>", ParagraphStyle("sub", parent=styles["Normal"], fontSize=7.5, leading=8, spaceBefore=0, spaceAfter=0)), Paragraph(f"<b>{fmt_br(sub_peso_kg)} kg</b>", ParagraphStyle("sp", parent=styles["Normal"], fontSize=7.5, leading=8, spaceBefore=0, spaceAfter=0)), "", Paragraph(f"<b>{fmt_br(sub_q)}</b>", ParagraphStyle("sq", parent=styles["Normal"], fontSize=7.5, leading=8, spaceBefore=0, spaceAfter=0)), Paragraph(f"<b>{fmt_br(sub_t)}</b>", ParagraphStyle("st", parent=styles["Normal"], fontSize=7.5, leading=8, spaceBefore=0, spaceAfter=0))])
        ...
        tbl.setStyle(TableStyle([
            ...
            # Sem linhas horizontais entre linhas de produto: só moldura, separador do cabeçalho e linha do subtotal
